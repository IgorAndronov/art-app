    ...
    return (
        <div>
                ...
                <div className="container-fluid">
                    <ul className="navbar-nav" style={{marginLeft: "auto", marginRight: "auto"}}>
                        <li className="nav-item">
                            <a className="nav-link" href="#section1" onClick={() => setAboutVisibility("none")}>Shop</a>
                        </li>
                        <li className="nav-item">
            ...
            <div style={{display: aboutVisibility=="none"? "inherit":"none"}}>
                ...
                <br/>
                <div id="section2" className="container-fluid" style={{padding: "10px 20px", backgroundColor:"ghostwhite"}}>
                    <div style={{marginLeft: "auto", marginRight: "auto", textAlign: "center"}}>
                        <h5>Contacts:</h5>
                        <p>
                            For orders, questions and proposals get in touch:
                        </p>
                        <a href="#" onClick={() => window.open('mailto: info@linadonets.art')} style={{color: "rebeccapurple"}}>Email: info@linadonets.art</a> <br/>
                        ...
                        <a href="https://www.instagram.com/linadonets.art/" style={{fontColor:"black", marginLeft:"10px"}}>Instagram</a>
                    </div>
